...
public class FirebaseBankAccountHandler {
    ...
    public FirebaseBankAccountHandler() {
    ...
    private void initializeAndListenMain() {
        DatabaseReference userWalletsRef = database.getReference("users/" + uid + "/bankAccounts");
        userWalletsRef.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                System.out.println("%%%%%%%%%%%%%%%%%%%%%%% Banl Added");
